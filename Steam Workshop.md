...
Enables electricity transmission without powerlines (you still need to produce the electricity; you just don't have to worry about getting it anywhere).
...
>
> If you're getting strange results such as missing districts or park areas (actually hidden away in a corner), then try loading the original save using the option 'Ignore expanded 81 tiles data when next loading a save' (in the options panel).
